        ...
        .then( (querySnapshot) => {
            querySnapshot.forEach( (doc) => {
                ...
                data.push({
                    ...
                    '4.1. Nombre del Encuestado': iterDoc.capituloCuatro.nombre || '', 
                    '4.2. Tipo de Doc. del Encuestado': iterDoc.capituloCuatro.tipoIdentificacion || '', 
                    '4.2.1. Tipo de Identificación(Otro)': iterDoc.capituloCuatro.tipoIdentificacionOtroCual || '', 
                    '4.2.2. Número de Identificación del Encuestado': iterDoc.capituloCuatro.numeroIdentificacion || '', 
                    '4.3. Número Celular del Encuestado': iterDoc.capituloCuatro.numeroCelular || '', 
                    '4.4. Tiene Email': iterDoc.capituloCuatro.tieneEmail || '', 
                    '4.4.1. Email': iterDoc.capituloCuatro.correoElectronico || '', 
                    '4.5. Institución': iterDoc.capituloCuatro.institucion || '', 
                    '4.5.1. Institución(Otro)': iterDoc.capituloCuatro.institucionOtroCual || '', 
                    '4.6. Cargo en la Institución': iterDoc.capituloCuatro.cargoInstitucion || '', 
                    '4.7. Actividad Adjudicada': iterDoc.capituloCuatro.actividadAdjudicada || '', 
                    '4.8. Estado Actual de la Infraestructura': iterDoc.capituloCuatro.estadoActual || '', 
                    '4.9. Calidad del Servicio': iterDoc.capituloCuatro.calidadServicioPrestado || '', 
                    '4.10. Inversión Actividades': iterDoc.capituloCuatro.inversionActividades || '', 
                    '4.10.1. Inversión Actividades Tiempo': iterDoc.capituloCuatro.inversionActividadesTiempo || '', 
                    '4.11. Observaciones Capitulo Cuatro': iterDoc.capituloCuatro.observacionesCapituloCuatro || '', 
